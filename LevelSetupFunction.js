...
function setupLevels() {
    ...
    tempLevel.lines.push(new Line(1160, 0, 1160, 860))
    tempLevel.lines.push(new Line(40, 860, 1160, 860))
    tempLevel.lines.push(new Line(40, 0, 40, 860))
    tempLevel.lines.push(new Line(900, 440, 900, 860))
    tempLevel.lines.push(new Line(900, 440, 1160, 440))
    tempLevel.lines.push(new Line(740, 480, 840, 480))
    tempLevel.lines.push(new Line(740, 480, 740, 520))
    tempLevel.lines.push(new Line(740, 520, 840, 520))
    tempLevel.lines.push(new Line(840, 480, 840, 520))
    tempLevel.lines.push(new Line(520, 540, 520, 860))
    tempLevel.lines.push(new Line(440, 540, 520, 540))
    tempLevel.lines.push(new Line(440, 540, 440, 860))
    tempLevel.lines.push(new Line(280, 600, 380, 600))
    tempLevel.lines.push(new Line(280, 580, 280, 600))
    tempLevel.lines.push(new Line(280, 580, 380, 580))
    tempLevel.lines.push(new Line(380, 580, 380, 600))
    tempLevel.lines.push(new Line(180, 620, 180, 860))
    tempLevel.lines.push(new Line(40, 620, 180, 620))
    tempLevel.lines.push(new Line(340, 360, 460, 360))
    tempLevel.lines.push(new Line(340, 340, 340, 360))
    tempLevel.lines.push(new Line(340, 340, 460, 340))
    tempLevel.lines.push(new Line(460, 340, 460, 360))
    tempLevel.lines.push(new Line(40, 380, 120, 380))
    tempLevel.lines.push(new Line(120, 380, 120, 400))
    tempLevel.lines.push(new Line(40, 400, 120, 400))
    tempLevel.lines.push(new Line(220, 440, 280, 440))
    tempLevel.lines.push(new Line(280, 420, 280, 440))
    tempLevel.lines.push(new Line(220, 420, 280, 420))
    tempLevel.lines.push(new Line(220, 420, 220, 440))
    tempLevel.lines.push(new Line(40, 80, 280, 80))
    tempLevel.lines.push(new Line(280, 80, 280, 240))
    tempLevel.lines.push(new Line(40, 240, 280, 240))
    tempLevel.lines.push(new Line(640, 260, 860, 260))
    tempLevel.lines.push(new Line(860, 0, 860, 260))
    tempLevel.lines.push(new Line(640, 0, 640, 260))
    tempLevel.lines.push(new Line(640, 0, 860, 0))
    tempLevel.lines.push(new Line(520, 140, 640, 140))
    tempLevel.lines.push(new Line(520, 140, 520, 180))
    tempLevel.lines.push(new Line(520, 180, 640, 180))
