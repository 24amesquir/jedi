...
function setupLevels() {
    ...
    tempLevel.lines.push(new Line(740, 620, 820, 620))
tempLevel.lines.push(new Line(820, 620, 820, 640))
tempLevel.lines.push(new Line(740, 640, 820, 640))
tempLevel.lines.push(new Line(740, 620, 740, 640))
tempLevel.lines.push(new Line(1020, 540, 1020, 880))
tempLevel.lines.push(new Line(1020, 540, 1180, 540))
tempLevel.lines.push(new Line(1180, 0, 1180, 540))
tempLevel.lines.push(new Line(20, 880, 1020, 880))
tempLevel.lines.push(new Line(20, 0, 20, 880))
tempLevel.lines.push(new Line(420, 340, 480, 340))
tempLevel.lines.push(new Line(480, 340, 480, 360))
tempLevel.lines.push(new Line(420, 360, 480, 360))
tempLevel.lines.push(new Line(420, 340, 420, 360))
tempLevel.lines.push(new Line(20, 360, 200, 360))
tempLevel.lines.push(new Line(200, 360, 200, 880))
tempLevel.lines.push(new Line(340, 640, 360, 640))
tempLevel.lines.push(new Line(360, 620, 360, 640))
tempLevel.lines.push(new Line(340, 620, 360, 620))
tempLevel.lines.push(new Line(340, 620, 340, 640))
tempLevel.lines.push(new Line(420, 540, 440, 540))
tempLevel.lines.push(new Line(440, 520, 440, 540))
tempLevel.lines.push(new Line(420, 520, 440, 520))
tempLevel.lines.push(new Line(420, 520, 420, 540))
tempLevel.lines.push(new Line(260, 420, 260, 440))
tempLevel.lines.push(new Line(260, 440, 280, 440))
tempLevel.lines.push(new Line(280, 420, 280, 440))
tempLevel.lines.push(new Line(260, 420, 280, 420))
tempLevel.lines.push(new Line(640, 180, 780, 180))
tempLevel.lines.push(new Line(780, 160, 780, 180))
tempLevel.lines.push(new Line(640, 160, 780, 160))
tempLevel.lines.push(new Line(640, 160, 640, 180))
tempLevel.lines.push(new Line(960, 120, 1180, 120))
tempLevel.lines.push(new Line(960, 60, 960, 120))
tempLevel.lines.push(new Line(960, 60, 1180, 60))
tempLevel.lines.push(new Line(20, 120, 40, 120))
tempLevel.lines.push(new Line(40, 100, 40, 120))
tempLevel.lines.push(new Line(20, 100, 40, 100))
tempLevel.lines.push(new Line(140, 180, 160, 180))
tempLevel.lines.push(new Line(160, 160, 160, 180))
tempLevel.lines.push(new Line(140, 160, 160, 160))
tempLevel.lines.push(new Line(140, 160, 140, 180))
