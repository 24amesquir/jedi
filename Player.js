...
class Player {
    ...
    constructor() {
        ...
        this.runCycle = [run1Image, run1Image, run1Image, run1Image, run2Image, run2Image, run2Image, run2Image, run3Image, run3Image, run4Image, run4Image, run5Image, run5Image, run6Image, run6Image, run7Image, run7Image, run8Image, run8Image, run9Image, run9Image, run10Image, run10Image]
